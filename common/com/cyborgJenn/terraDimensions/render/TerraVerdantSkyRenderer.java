...
public class TerraVerdantSkyRenderer extends IRenderHandler {
	...
	private static final ResourceLocation sunTexture = new ResourceLocation(Reference.TEXTURE + "textures/environment/sun.png"); 
	private int starGLCallList;
	private int glSkyList;
	private int glSkyList2;
	public TerraVerdantSkyRenderer()
	{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
	  ...
	  if (afloat != null)
	  {
	   ...
	   if (mc.gameSettings.anaglyph)
	   {
	        f9 = (f4 * 5.0F + f7 * 59.0F + f8 * 11.0F) / 100.0F;
