...
public class ModelSpud extends ModelBase
{
  //fields
    ModelRenderer head;
    ModelRenderer body;
  ...
  public ModelSpud()
  {
    ...
    textureHeight = 32;
      ...
      leftEar = new ModelRenderer(this, 32, 0);
      leftEar.addBox(0F, -2F, 0F, 3, 3, 1);
      leftEar.setRotationPoint(2F, 0F, 0F);
      leftEar.setTextureSize(64, 32);
      leftEar.mirror = true;
      setRotation(leftEar, 0F, 0F, 0.2617994F);
      RightEar = new ModelRenderer(this, 32, 0);
      RightEar.addBox(-3F, -2F, 0F, 3, 3, 1);
      RightEar.setRotationPoint(-2F, 0F, 0F);
      RightEar.setTextureSize(64, 32);
      RightEar.mirror = true;
      setRotation(RightEar, 0F, 0F, -0.2617994F);
      Tail = new ModelRenderer(this, 32, 4);
      Tail.addBox(-0.5F, -1F, 0F, 1, 2, 2);
      Tail.setRotationPoint(0F, 14F, 2F);
