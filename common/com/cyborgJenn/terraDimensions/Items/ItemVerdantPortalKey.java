...
public class ItemVerdantPortalKey extends Item{
	public ItemVerdantPortalKey(int par1) {
        super();
        maxStackSize = 1;
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer,
        ...
        if (blockID == ModBlocks.gateVerdant){
            ModBlocks.verdantPortal.func_150000_e(par3World, par4, par5 + 1, par6);
        }
        return true;
