...
public class BlockGalifreyGrass extends Block implements IGrowable{
	...
	public BlockGalifreyGrass(int par1) {
    ...
    public IIcon getIcon(int par1, int par2) {
			return par1 == 1 ? iconGrassTop : (par1 == 0 ? ModBlocks.galifreyDirt.getBlockTextureFromSide(par1) : blockIcon);  
    }
	/**
    ...
    public Item getItemDropped(int par1, Random par2Random, int par3) {
        return ModBlocks.galifreyDirt.getItemDropped(0, par2Random, par3);
    }
    /**
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        if (!par1World.isRemote){
            if ((par1World.getBlockLightValue(par2, par3 + 1, par4) < 4)
                ...
                par1World.setBlock(par2, par3, par4, ModBlocks.galifreyDirt);
                ...
                for (int l = 0; l < 4; ++l){
                    ...
                    if ((par1World.getBlock(i1, j1, k1) == ModBlocks.galifreyDirt)
    ...
    public IIcon getIcon(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
        ...
        {
            return ModBlocks.galifreyDirt.getBlockTextureFromSide(par5);
        }
        else
        {
    ...
    {
        if (this == ModBlocks.galifreyGrass )// TODO: add back farm land ** || this == ModBlocks.verdantFarmLand **
        {
            world.setBlock(x, y, z, ModBlocks.galifreyDirt, 0, 2);
        }
    }
	@Override
