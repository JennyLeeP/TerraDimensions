...
public class TerraVerdantTeleporter extends Teleporter {
    ...
    public TerraVerdantTeleporter(WorldServer par1WorldServer) {
                ...
                for (int i1 = -2; i1 <= 2; ++i1){
                    for (int j1 = -1; j1 < 3; ++j1){
                        ...
                        worldServerInstance.setBlock(k1, l1, i2,
                                (Block) (flag ? ModBlocks.gateVerdant : 0));
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6,
            ...
            for (k1 = l - short1; k1 <= (l + short1); ++k1){
                ...
                for (int l1 = i1 - short1; l1 <= (i1 + short1); ++l1){
                    ...
                    for (int i2 = worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2){
                        if (worldServerInstance.getBlock(k1, i2, l1) == ModBlocks.verdantPortal){
                            while (worldServerInstance.getBlock(k1, i2 - 1, l1) == ModBlocks.verdantPortal){
                                --i2;
                            }
        ...
        if (d3 >= 0.0D){
            ...
            if (worldServerInstance.getBlock(i - 1, j, k) == ModBlocks.verdantPortal){
                j2 = 2;
            }
            ...
            if (worldServerInstance.getBlock(i, j, k - 1) == ModBlocks.verdantPortal){
                j2 = 3;
            }
