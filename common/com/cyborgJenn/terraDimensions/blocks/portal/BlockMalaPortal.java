...
public class BlockMalaPortal extends BlockPortal{
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Reference.TEXTURE + "portalMala");
    }
	@SideOnly(Side.CLIENT)
	/**
    ...
    */
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
        ...
        else if (thePlayer.dimension != Config.dimensionMalaID)
        {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Config.dimensionMalaID, new TerraVerdantTeleporter(thePlayer.mcServer.worldServerForDimension(Config.dimensionMalaID),Config.dimensionMalaID));
        }
        else {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TerraVerdantTeleporter(thePlayer.mcServer.worldServerForDimension(0), Config.dimensionMalaID));
        }
        }
    ...
    */
    ...
    {
    	BlockMalaPortal.Size size = new BlockMalaPortal.Size(world, par2, par3, par4, 1);
    	BlockMalaPortal.Size size1 = new BlockMalaPortal.Size(world, par2, par3, par4, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        BlockMalaPortal.Size size = new BlockMalaPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        BlockMalaPortal.Size size1 = new BlockMalaPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
    ...
    public static class Size
    {
        ...
        public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
        {
            ...
            this.field_150863_d = BlockMalaPortal.field_150001_a[p_i45415_5_][0];
            this.field_150866_c = BlockMalaPortal.field_150001_a[p_i45415_5_][1];
        ...
        protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
        {
            ...
            block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
            return block == ModBlocks.gateMala ? i1 : 0;
        }
        ...
        protected int func_150858_a()
        {
            ...
            for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
            {
                ...
                {
                    k = this.field_150861_f.posX + j * Direction.offsetX[BlockMalaPortal.field_150001_a[this.field_150865_b][1]];
                    l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockMalaPortal.field_150001_a[this.field_150865_b][1]];
                    ...
                    if (j == 0)
                    {
                        block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockMalaPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockMalaPortal.field_150001_a[this.field_150865_b][0]]);

                        if (block != ModBlocks.gateMala)
                        {
                            break label56;
                        }
                    }
                    ...
                    {
                        block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockMalaPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockMalaPortal.field_150001_a[this.field_150865_b][1]]);
            ...
            {
                j = this.field_150861_f.posX + i * Direction.offsetX[BlockMalaPortal.field_150001_a[this.field_150865_b][1]];
                k = this.field_150861_f.posY + this.field_150862_g;
                l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockMalaPortal.field_150001_a[this.field_150865_b][1]];

                if (this.field_150867_a.getBlock(j, k, l) != ModBlocks.gateMala)
                {
        ...
        {
            return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == ModBlocks.malaPortal;
        }
        ...
        public void func_150859_c()
        {
            for (int i = 0; i < this.field_150868_h; ++i)
            {
                ...
                for (int l = 0; l < this.field_150862_g; ++l)
                {
                    ...
                    this.field_150867_a.setBlock(j, i1, k, ModBlocks.malaPortal, this.field_150865_b, 2);
                }
            }
        }
    }
