...
public class BlockGalifreyPortal extends BlockPortal{
	public BlockGalifreyPortal() { // Par1 = which portal, 0 = verdant, 1 = mala, 2 = galifrey
        super();
        ...
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null)){
            ...
            if ((par5Entity.timeUntilPortal == 0) && (par5Entity instanceof EntityPlayerMP)){
                ...
                WorldServer worldserver1 = minecraftserver
                        .worldServerForDimension(Config.dimensionVerdantID);
                if (dimID == Config.dimensionVerdantID){
                    ...
                    minecraftserver.getConfigurationManager().transferPlayerToDimension(
                            (EntityPlayerMP) par5Entity, Config.dimensionVerdantID,
