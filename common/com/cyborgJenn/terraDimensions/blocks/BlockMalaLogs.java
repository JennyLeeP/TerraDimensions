...
public class BlockMalaLogs extends Block{
	
	public static final String[] MalaWoodType = new String[] {"charred","dark","infernal", "death"};
    public static final String[] MalaTreeTextureTops = new String[] {"charred_top","dark_top","infernal_top", "death_top"};
    ...
    {
        for(int i = 0; i < MalaWoodType.length; i++){
    ...
    {
		this.iconArrayTS = new IIcon[MalaWoodType.length];
        this.iconArrayTT = new IIcon[MalaTreeTextureTops.length];
        
        for (int j = 0; j < this.iconArrayTT.length; ++j)
        {
            this.iconArrayTT[j] = iconregister.registerIcon(Reference.TEXTURE + "log_" +MalaTreeTextureTops[j]);
        }
        for (int i = 0; i < this.iconArrayTS.length; ++i)
        {
            this.iconArrayTS[i] = iconregister.registerIcon(Reference.TEXTURE + "log_" +MalaWoodType[i]);
        }
    }
