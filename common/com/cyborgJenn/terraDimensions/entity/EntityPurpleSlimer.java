...
public class EntityPurpleSlimer extends EntityLiving implements IMob{
	...
	public EntityPurpleSlimer(World par1World)
    {
        super(par1World);
  ...
  //TODO fix slime drops and particles
    /**
     * Returns the name of a particle effect that may be randomly created by EntitySlime.onUpdate()
     */
    protected String getPurpleSlimeParticle()
    {
        return "slime";
    }
    ...
    public void onUpdate()
    {
        ...
        if (this.onGround && !flag)
        {
            ...
            for (int j = 0; j < i * 8; ++j)
            {
                ...
                this.worldObj.spawnParticle(this.getPurpleSlimeParticle(), this.posX + (double)f2, this.boundingBox.minY, this.posZ + (double)f3, 0.0D, 0.0D, 0.0D);
            }
    ...
    protected EntityPurpleSlimer createInstance()
    {
        return new EntityPurpleSlimer(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                EntityPurpleSlimer entityslime = this.createInstance();
