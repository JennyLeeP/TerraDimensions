...
public class WorldGenMangroveTrees extends WorldGenAbstractTree{
    ...
    public boolean generate(World par1World, Random par2Random, int posX, int posY, int posZ)
    {
        ...
        if (posY >= 1 && posY + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(par1World, posX, posY - 1, posZ, ForgeDirection.UP, (BlockTerraSaplings)ModBlocks.terraSaplings);
                if (isSoil && posY < 256 - l - 1)
                {
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, posX, posY + k1, posZ, ModBlocks.verdantLogs, this.metaWood);
    ...
    {
        this.setBlockAndNotifyAdequately(par1World, par2, par3, posY, Blocks.vine, posZ);
        int i1 = 4;
        ...
        while (true)
        {
            ...
            if (par1World.getBlock(par2, par3, posY).isAir(par1World, par2, par3, posY) || i1 <= 0)
            {
                return;
            }
