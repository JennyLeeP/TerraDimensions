...
import com.cyborgJenn.terraDimensions.world.biome.BiomeGenTDBase;
import com.cyborgJenn.terraDimensions.world.generators.MapGenCavesTD;
import com.cyborgJenn.terraDimensions.world.generators.MapGenRavineTD;
import com.cyborgJenn.terraDimensions.world.generators.MapGenVillageTD;

import cpw.mods.fml.common.eventhandler.Event.Result;

public class ChunkProviderTerraMala implements IChunkProvider{
	/**
     * RNG.
     */
    private Random rand;
    ...
    private MapGenBase caveGenerator = new MapGenCavesTD();
    /**
     ...
     */
    private MapGenVillage villageGenerator = new MapGenVillageTD();
    /**
     ...
     */
    private MapGenBase ravineGenerator = new MapGenRavineTD();
    /**
	...
	public ChunkProviderTerraMala(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                	blockArray[j3 += short1] = ModBlocks.malaStone;
                                }
                                else if (k2 * 8 + l2 < sLevel)
                                {
                                	blockArray[j3 += short1] = TerraFluidsHandler.blockFluidTerraLava;
                                }
                                else
                                {
	...
	public void replaceBlocksForBiome(int chunkX, int chunkZ, Block[] blockArray, byte[] byteArray, BiomeGenBase[] par5BiomeArray)
    {
        ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, chunkX, chunkZ, blockArray, par5BiomeArray);
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
            	//blockArray[0] = ModBlocks.verdantDirt;
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
            ...
            && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAKE))
        {
            ...
            (new WorldGenLakes(TerraFluidsHandler.blockFluidMercury)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
        ...
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new WorldGenLakes(TerraFluidsHandler.blockFluidTerraLava)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
