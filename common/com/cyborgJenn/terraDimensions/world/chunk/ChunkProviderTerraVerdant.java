...
public class ChunkProviderTerraVerdant implements IChunkProvider{
	/**
     * RNG.
     */
    private Random rand;
	...
	public ChunkProviderTerraVerdant(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                	blockArray[j3 += short1] = ModBlocks.verdantStone;
                                }
